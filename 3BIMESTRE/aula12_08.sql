...
INSERT INTO `clientes` (`nome`, `id_cliente`, `estado`, `email`) VALUES
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`),
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`codigo`) REFERENCES `produto` (`codigo`);
COMMIT;
